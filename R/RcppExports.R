...
#' @noRd
fit_kde1d_cpp <- function(x, nlevels, zero_inflated, bw, mult, xmin, xmax, deg, weights) {
    .Call('_kde1d_fit_kde1d_cpp', PACKAGE = 'kde1d', x, nlevels, zero_inflated, bw, mult, xmin, xmax, deg, weights)
}
