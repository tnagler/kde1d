...
// fit_kde1d_cpp
Rcpp::List fit_kde1d_cpp(const Eigen::VectorXd& x, size_t nlevels, double bandwidth, double mult, double xmin, double xmax, size_t degree, const Eigen::VectorXd& weights);
RcppExport SEXP _kde1d_fit_kde1d_cpp(SEXP xSEXP, SEXP nlevelsSEXP, SEXP bandwidthSEXP, SEXP multSEXP, SEXP xminSEXP, SEXP xmaxSEXP, SEXP degreeSEXP, SEXP weightsSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(fit_kde1d_cpp(x, nlevels, bandwidth, mult, xmin, xmax, degree, weights));
